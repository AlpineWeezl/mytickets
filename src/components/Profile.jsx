...
const Profile = () => {
	const { verified, setVerified, user, setUser, token, setToken } =
	...
	const updateHandler = (e) => {
		...
		axios
			.put(`${apiUrl}/users/${user._id}`, modUser, {
	...
	const passwordHandler = (e) => {
		...
		axios
			.put(
				`${apiUrl}/users/password/${user._id}`,
		...
		verified && (
			<div className="bg-white rounded-md shadow-md mb-14 z-0">
				<div className="flex flex-col justify-center items-center py-3 border-b-2 border-black text-center">
					<h2 className="text-2xl my-3">{`Hallo ${
				...
				<div className="w-[85%] mx-auto py-3 my-3">
					...
					>
						...
						<div className="flex flex-col">
							<label htmlFor="fistname" className="text-xs">
								Vorname
							</label>
							<input
								id="firstname"
								aria-describedby="firstname-helper-text border"
								type="text"
						...
						<div className="flex justify-around my-3">
							<button
								type="reset"
								className="p-2 w-20 rounded shadow bg-red-600 text-white"
							>
								<PersonOutlined /> <RestartAlt />
							</button>
							<button
								type="submit"
								className="p-2 w-20 rounded shadow bg-green-700 text-white"
							>
								<PersonOutlined /> <Save />
							</button>
						</div>
				...
				<div className="w-[85%] mx-auto py-3 my-3">
					...
					>
						...
						<div className="flex flex-col">
							<label htmlFor="passwordRepeat" className="text-xs">
								Passwort wiederholen
							</label>
							<input
								id="passwordRepeat"
								aria-describedby="password-repeat-helper-text"
								type="password"
								className="border-b-2 p-2"
							/>
						</div>
